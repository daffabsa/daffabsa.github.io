...
export default {
    head() {
        return {
            title: `Sign-in signup 2 | SmartHRIS - Aplikasi HR lengkap dari BSA`,
        };
    },
    data() {
        return {};
...
<div>
    ...
    <footer class="footer footer-alt">
        <p class="text-muted">
            {{ new Date().getFullYear() }}&copy; SmartHRIS by
            <a href="javascript: void(0);" class="text-dark">Bima Sakti Alterra</a>
        </p>
    </footer>
</div>
</template>
