...
export default {
    head() {
        return {
            title: `Error-404-alt | SmartHRIS - Aplikasi HR lengkap dari BSA`
        }
    },
}
</script>
...
<div class="row justify-content-center my-5">
    <div class="col-lg-6 col-xl-4 mb-4">
        ...
        <div class="text-center">
            ...
            <nuxt-link to="/account/login" class="btn btn-success waves-effect waves-light">Back to Dashboard</nuxt-link>
        </div>
