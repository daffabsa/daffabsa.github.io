...
export default {
  ...
  methods: {
    ...
    setLanguage(locale, country, flag) {
      ...
      console.log('setLanguage',this.current_language)
          ...
          <simplebar style="max-height: 230px;">
            <a href="javascript:void(0);" class="dropdown-item notify-item active">
              ...
              <p class="notify-details">
                ...
                <small
                  class="text-muted"
                >{{ $t('navbar.dropdown.notification.1.text') }}</small>
              </p>
            </a>
            ...
            <a href="javascript:void(0);" class="dropdown-item notify-item">
              ...
              <p class="notify-details">
                ...
                <small
                  class="text-muted"
                >{{ $t('navbar.dropdown.notification.4.text') }}</small>
              </p>
            </a>
            ...
            <a href="javascript:void(0);" class="dropdown-item notify-item">
              ...
              <p class="notify-details">
                ...
                <small
                  class="text-muted"
                >{{ $t('navbar.dropdown.notification.5.text') }}</small>
              </p>
            </a>
            ...
            <a href="javascript:void(0);" class="dropdown-item notify-item">
              ...
              <p class="notify-details">
                ...
                <small
                  class="text-muted"
                >{{ $t('navbar.dropdown.notification.6.text') }}</small>
              </p>
            </a>
          </simplebar>
      ...
      <div class="logo-box">
        <nuxt-link to="/" class="logo logo-dark text-center">
          <span class="logo-sm">
            ...
            <!-- <span class="logo-lg-text-light">SmartHRS</span> -->
          </span>
          <span class="logo-lg">
          ...
          <div class="row">
                ...
                <div class="col-md-4">
                  ...
                  <ul class="list-unstyled megamenu-list">
                    <li>
                      <a
                        href="javascript:void(0);"
                      >{{ $t('navbar.dropdown.megamenu.uicontent.list.widgets') }}</a>
                    </li>
                    <li>
                      <a
                        href="javascript:void(0);"
                      >{{ $t('navbar.dropdown.megamenu.uicontent.list.nestable') }}</a>
                    </li>
                    <li>
                      <a
                        href="javascript:void(0);"
                    ...
                    <li>
                      <a
                        href="javascript:void(0);"
                      >{{ $t('navbar.dropdown.megamenu.uicontent.list.masonry') }}</a>
                    </li>
                    <li>
                      <a
                        href="javascript:void(0);"
                    ...
                    <li>
                      <a
                        href="javascript:void(0);"
                      >{{ $t('navbar.dropdown.megamenu.uicontent.list.treeview') }}</a>
                    </li>
                    <li>
                      <a
                        href="javascript:void(0);"
                      >{{ $t('navbar.dropdown.megamenu.uicontent.list.tour') }}</a>
                    </li>
                  </ul>
                </div>
                ...
                <div class="col-md-4">
                  ...
                  <ul class="list-unstyled megamenu-list">
                    ...
                    <li>
                      <a
                        href="javascript:void(0);"
                      >{{ $t('navbar.dropdown.megamenu.application.list.template') }}</a>
                    </li>
                  </ul>
                </div>
                ...
                <div class="col-md-4">
                  ...
                  <ul class="list-unstyled megamenu-list">
                    <li>
                      <a
                        href="javascript:void(0);"
                      >{{ $t('navbar.dropdown.megamenu.extrapages.list.leftsidebaruser') }}</a>
                    </li>
                    <li>
                      <a
                        href="javascript:void(0);"
                      >{{ $t('navbar.dropdown.megamenu.extrapages.list.collapsed') }}</a>
                    </li>
                    <li>
                      <a
                        href="javascript:void(0);"
                      >{{ $t('navbar.dropdown.megamenu.extrapages.list.leftsidebar') }}</a>
                    </li>
                    <li>
                      <a
                        href="javascript:void(0);"
                      >{{ $t('navbar.dropdown.megamenu.extrapages.list.header') }}</a>
                    </li>
                    <li>
                      <a
                        href="javascript:void(0);"
                      >{{ $t('navbar.dropdown.megamenu.extrapages.list.search') }}</a>
                    </li>
                    <li>
                      <a
                        href="javascript:void(0);"
                      >{{ $t('navbar.dropdown.megamenu.extrapages.list.gallery') }}</a>
                    </li>
                    <li>
                      <a
                        href="javascript:void(0);"
            ...
            <div class="col-sm-4">
              <div class="text-center mt-3">
                ...
                >{{ $t('navbar.dropdown.megamenu.buttontext') }}</button>
              </div>
            </div>
          </div>
        </b-nav-item-dropdown>
